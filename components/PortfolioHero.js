        ...
        <div className="w-[95%] sm2:w-[90%] lg:w-[85%] flex flex-col items-end justify-between gap-[4vw]">
          ...
          <div className="w-full h-full flex flex-col items-end justify-center text-left gap-[2.5vw] lg:gap-[1.5vw] text-[2.8vw] lg:text-[1vw] font-medium text-[#51375bbd]">
            <p ref={paragraph1} className="w-full text-left">
              Our portfolio showcases a meticulous blend of dedication and
              expertise. Every project, from the initial concept to the final
              execution, receives our unwavering attention, ensuring an
              unparalleled level of craftsmanship.
              <br />
              <span className="pt-[2vw] lg:pt-[1vw]">
                Our designs transcend mere luxury; they represent a commitment to
                excellence and innovation. We've meticulously crafted each project to
                reflect our dedication to quality, offering distinctive spaces that
                can be dream homes or profitable investments, all while
                delivering exceptional returns on more than just finances.
              </span>
            </p>
          </div>
        </div>
