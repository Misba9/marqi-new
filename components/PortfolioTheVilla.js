...
const portfolioFeatures = [
  {
    ...
    description:
      "Our portfolio showcases innovative design solutions that blend aesthetics with functionality, creating spaces that stand the test of time.",
  },
  {
    logo: "/buildings.svg",
    width: "w-16 mb-6",
    title: "Quality Craftsmanship",
    description: "Meticulous attention to detail in every project ensures premium quality construction and finishing.",
  },
  {
    logo: "/road.svg",
    width: "w-16 mb-5",
    ...
    description:
      "From residential villas to commercial complexes, our portfolio demonstrates versatility and adaptability across various architectural styles.",
  },
  {
    logo: "/business.svg",
    width: "w-16 mb-8",
    ...
    description:
      "Our projects incorporate eco-friendly materials and energy-efficient solutions that reduce environmental impact.",
  },
  {
    logo: "/charminar.svg",
    width: "w-24",
    ...
    description:
      "Each project in our portfolio reflects our commitment to understanding and exceeding client expectations.",
  },
  {
    logo: "/secured.svg",
    width: "w-16 mb-7",
    ...
    description:
      "We leverage the latest construction technologies and design software to deliver cutting-edge architectural solutions.",
  },
];

gsap.registerPlugin(ScrollTrigger);

const PortfolioTheVilla = () => {
  ...
  return (
    <div className="gridlayout w-full flex justify-center text-[#51375bce]">
      <div className="w-[95%] sm2:w-[90%] lg:w-[85%] flex items-center justify-between gap-[3vw] lg:gap-[1.5vw] flex-col">
        ...
        <TypewriterGSAP
          text="what makes our portfolio special"
          mainClassName="w-full text-center"
...
export default PortfolioTheVilla;